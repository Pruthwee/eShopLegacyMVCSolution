...
namespace eShopPorted.Infrastructure.Data;

/// <summary>
/// Seeds initial data for the catalog
/// </summary>
public static class CatalogDbContextSeed
{
    public static async Task SeedAsync(CatalogDbContext context, ILogger logger, bool useCustomizationData = false)
    {
        try
        {

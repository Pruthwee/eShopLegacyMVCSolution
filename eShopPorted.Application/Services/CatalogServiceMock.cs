...
{
    /// <summary>
    /// Mock implementation of catalog service for testing
    /// </summary>
    public class CatalogServiceMock : ICatalogService
    {
        ...
        public Task<PaginatedItemsViewModel<CatalogItem>> GetCatalogItemsPaginatedAsync(int pageSize, int pageIndex)
        {
            ...
            var result = new PaginatedItemsViewModel<CatalogItem>(
        ...
        {
            var item = _catalogItems.FirstOrDefault(ci => ci.Id == id);
            return Task.FromResult(item);
        }

        public Task<IEnumerable<CatalogType>> GetCatalogTypesAsync()
        {
            return Task.FromResult<IEnumerable<CatalogType>>(_catalogTypes);
        }

        public Task<IEnumerable<CatalogBrand>> GetCatalogBrandsAsync()
        {
            return Task.FromResult<IEnumerable<CatalogBrand>>(_catalogBrands);
        }
